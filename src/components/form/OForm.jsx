        ...
        <form data-bitwarden-watching="1">
            ...
            <div className="grid grid-cols-3 gap-16">
                <div class="mb-6 col-end-3 col-span-2">
                    ...
                    <input type="text" id="o_name" class="shadow-sm border border-gray-300 text-gray-900 text-md rounded-lg focus:border-blue block w-full p-2.5" onChange={(event)=>{
                ...
                <div className="mb-6">
                    ...
                    <input type="text" id="o_id" class="shadow-sm border border-gray-300 text-gray-900 text-md rounded-lg focus:border-blue block w-full p-2.5" placeholder= "ex. 293-362" onChange={(event)=>{
            ...
            <div className='grid md:grid-cols-2 gap-24'>
                <div class="mb-6">
                    ...
                    <input type="number" id="o_mobile" class="shadow-sm border border-gray-300 text-gray-900 text-md rounded-lg focus:border-blue block w-full p-2.5" placeholder="(+88)-" onChange={(event)=>{
                ...
                <div class="mb-6">
                    ...
                    <input type="email" id="o_mail" class="shadow-sm border border-gray-300 text-gray-900 text-md rounded-lg focus:border-blue block w-full p-2.5" placeholder="officer@example.com" onChange={(event)=>{
