    ...
    <div>
        ...
        <form data-bitwarden-watching="1" id='tForm'>
            ...
            <div className="grid grid-cols-4 gap-12">
                <button onClick={tFormValidation} type="button" id='t_submit' class="col-start-3 text-white bg-blue border border-2 border-blue hover:bg-lblue hover:border-lblue hover:text-white focus:outline-none font-medium rounded-lg text-md px-5 py-2.5 text-center">Add New Teacher</button>
