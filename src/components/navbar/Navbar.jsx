    ...
    <div className='navbar relative h-12 w-full flex items-center'>
      <form class="flex items-center">   
          ...
          <div class="relative w-full m-7">
              ...
              <input type="text" id="simple-search" class=" focus:ring-0 ring-0 focus:border-violet-800 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full pl-10 p-2.5" placeholder="Search..." required=""/>
          </div>
      </form>
