    ...
    <div className='flex-initial border-r h-screen relative bg-white text-black shadow-xl'>
        ...
        <div className="center px-2">
            <ul className='list-none m-0 p-0'>
                ...
                <li>
                    <Link to="/dashboard" className='flex gap-2 items-center pr-6 pl-2 my-2 py-1.5 text-xl hover:text-black hover:bg-hblue rounded-md cursor-pointer'>
                ...
                <li>
                    <Link to="/students" className='flex gap-2 items-center pr-6 pl-2 my-2 py-1.5 text-xl hover:text-black hover:bg-hblue rounded-md cursor-pointer'>
                        <FaIcons.FaBookReader className='text-black text-2xl'/>
                        <span className='text-gray-600'>Students</span>
                    </Link>
                </li>
                <li>
                    <Link to="/teacher" className='flex gap-2 items-center pr-6 pl-2 my-2 py-1.5 text-xl hover:text-black hover:bg-hblue rounded-md cursor-pointer'>
                ...
                <li>
                    <Link to="/login" className='flex gap-2 items-center pr-6 pl-2 mb-2 py-1.5 text-xl hover:text-black hover:bg-hblue rounded-md cursor-pointer'>
