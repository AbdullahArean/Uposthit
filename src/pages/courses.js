  ...
  return (
    <div className='courses'>
      ...
      <div className='text-2xl ml-10 mt-5'>
        Courses offered for students in 1st year
      </div>
      <hr className='my-5 mx-10' />
      ...
      <div className='text-2xl ml-10 mt-5'>
        Courses offered for students in 2nd year
      </div>
      <hr className='my-5 mx-10' />
      <div class='grid grid-cols-4 gap-4 mx-10'>
        {CoursesData.map((course,index) => (
      ...
      <div className='text-2xl ml-10 mt-5'>
        Courses offered for students in 3rd year
      </div>
      <hr className='my-5 mx-10' />
      <div class='grid grid-cols-4 gap-4 mx-10'>
        {CoursesData.map((course,index) => (
      ...
      <div className='text-2xl ml-10 mt-5'>
        Courses offered for students in 4th year
      </div>
      <hr className='my-5 mx-10' />
      <div class='grid grid-cols-4 gap-4 mx-10'>
        {CoursesData.map((course,index) => (
